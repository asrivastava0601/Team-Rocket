...
We use accuracy and [Cohen's Kappa](https://www.rdocumentation.org/packages/psych/versions/1.9.12.31/topics/cohen.kappa){target="_blank"} measure to check for model performance. 
